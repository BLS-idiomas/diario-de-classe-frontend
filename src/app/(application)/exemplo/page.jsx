      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          <div className="bg-main p-6 rounded-lg shadow-md border border-main">
            ...
            <p className="text-3xl font-bold primary-color">142</p>
          </div>
        ...
        <div className="bg-main p-8 rounded-lg shadow-md border border-main">
          ...
          <div className="space-y-4">
            <div className="flex items-center p-4 bg-secondary rounded-lg">
              <div className="w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center mr-4">
                <span className="primary-color font-semibold">MG</span>
              </div>
              <div>
